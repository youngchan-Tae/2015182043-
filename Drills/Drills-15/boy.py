...
class WalkingState:
    ...
    def do(boy):
        ...
        boy.x = clamp(boy.y / 5.46 , boy.x, boy.bg.w - boy.y / 3.92)
...
class Boy:
    ...
    def draw(self):
        ...
        self.font.draw(self.x - self.bg.window_left - 10, self.y - self.bg.window_bottom + 50, '(%d)' % (main_state.ball_conut), (255, 255, 0))
