...
PIXEL_PER_METER = (10.0 / 0.3) # 10pixel 30 cm
...
#Boy Ghost Speed
GHOST_SPEED_MPS = 12 * 3.14 * PIXEL_PER_METER
...
class SleepState:
    ...
    def do(boy):
        boy.frame = (boy.frame + FRAMES_PER_ACTION * ACTION_PER_TIME * game_framework.frame_time) % 8
        boy.rad += math.radians(7.2)
        boy.Gx = (100 * math.cos(boy.rad))
        boy.Gy = (100 * math.sin(boy.rad))
        boy.timer -= 1
